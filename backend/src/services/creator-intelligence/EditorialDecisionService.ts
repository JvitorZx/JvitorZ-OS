...
export const isEditorialQuestion = (question: string): boolean =>
  ...
  || /(pesquis|procure|investigue|oportunidade|lacuna|tema surgindo|fora do meu canal|o que.*gravo hoje|fila editorial|plano editorial|o que vem depois|planej|calendario editorial|o que estamos testando|experimento|hipotese|resultado do teste|sinal estrategico|alerta estrategico|o que mudou|monitoramento)/i.test(question);
