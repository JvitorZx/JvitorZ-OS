...
const TEMPLATES: Record<ManagerIntent, ManagerPlanTemplate> = {
  ...
  PLANNING: { objective: 'Transformar evidencias e memoria em uma proxima acao editorial.', capabilities: ['data-quality', 'performance', 'decision-memory', 'shared-memory', 'editorial-decision'] },
