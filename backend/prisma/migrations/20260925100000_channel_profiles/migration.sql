CREATE TABLE "ChannelProfile" (
  ...
  CONSTRAINT "ChannelProfile_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);

ALTER TABLE "ChannelSnapshot" ADD COLUMN "channelProfileId" TEXT REFERENCES "ChannelProfile" ("id") ON DELETE SET NULL ON UPDATE CASCADE;
